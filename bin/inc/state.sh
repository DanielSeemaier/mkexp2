...
MKEXP2_DESCRIBE_ALL=0
MKEXP2_DESCRIBE_JSON=0
MKEXP2_PROBE_TARGET=""
...
MKEXP2_POSTPROCESS_AUTO_REQUIRED=0
MKEXP2_CHECK_ERROR_COUNT=0
MKEXP2_CHECK_WARN_COUNT=0
MKEXP2_CHECK_JSON=0
MKEXP2_PROGRESS_JSON=0
MKEXP2_STATS_JSON=0
typeset -a MKEXP2_CHECK_EXPERIMENT_JSON=()
typeset -a MKEXP2_CHECK_CURRENT_MESSAGES=()
typeset -a MKEXP2_PLOT_ALGORITHMS=()
typeset -a MKEXP2_PLOT_TYPES=()
...
MKEXP2_PLOT_OUTPUT=""
MKEXP2_PLOT_THREADS=""
MKEXP2_PLOT_NO_DOCKER=0
MKEXP2_PLOT_RESOLVE_SPACK_R_LIBS=0
MKEXP2_PLOT_REFRESH_SPACK_R_LIBS=0
MKEXP2_WEB_REPO=""
MKEXP2_WEB_HOST="127.0.0.1"
MKEXP2_WEB_PORT="8765"
MKEXP2_WEB_NAME_TEMPLATE="%Y.%m.%d-<name>"
MKEXP2_WEB_ALLOW_EMPTY_TOKEN=0
MKEXP2_WEB_TOKEN="${MKEXP2_WEB_TOKEN:-}"
MKEXP2_WEB_OPTION_SET=0
MKEXP2_MCP_URL="${MKEXP2_MCP_URL:-http://127.0.0.1:8765}"
MKEXP2_MCP_TOKEN="${MKEXP2_MCP_TOKEN:-}"
MKEXP2_MCP_OPTION_SET=0
...
typeset -a _epsilons=()
typeset -a _graphs=()
typeset -a _graph_directive_commands=()
typeset -a _graph_directive_paths=()
typeset -a _graph_directive_extensions=()
...
MKEXP2_INSTALL_LOG_FILE="${MKEXP2_INSTALL_LOG_FILE:-}"
MKEXP2_INSTALL_LOG_INITIALIZED=""
MKEXP2_RUN_VERBOSE="${MKEXP2_RUN_VERBOSE:-0}"
MKEXP2_ACTIVE_ALGORITHM=""
MKEXP2_SPACK_ENVIRONMENT="${MKEXP2_SPACK_ENVIRONMENT:-}"
...
ResetExperiment() {
  ...
  _epsilons=()
  _graphs=()
  _graph_directive_commands=()
  _graph_directive_paths=()
