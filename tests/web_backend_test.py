...
class WebBackendTest(unittest.TestCase):
    ...
    def test_html_contains_syntax_highlighting_editor(self):
        ...
        self.assertNotIn("pathLabel.textContent = 'logs/'", mkexp2_web.HTML)
        self.assertIn("pathLabel.textContent = dir ? `${dir}/` : ''", mkexp2_web.HTML)
        ...
        self.assertLess(mkexp2_web.HTML.index('id="plot-indicator"'), mkexp2_web.HTML.index('id="plot-results"'))
        self.assertLess(mkexp2_web.HTML.index('id="plot-results"'), mkexp2_web.HTML.index('id="plot-no-docker-label"'))
