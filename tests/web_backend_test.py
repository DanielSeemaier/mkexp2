...
class WebBackendTest(unittest.TestCase):
    ...
    def test_list_experiments_detects_nested_directories(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            (repo / "flat" / "plots").mkdir()
            (repo / "flat" / "plots" / "index.json").write_text('{"artifacts":[]}\n')
            ...
            self.assertFalse(nested["has_plot_artifacts"])
            self.assertTrue(experiments[1]["has_plot_artifacts"])
    ...
    def test_html_contains_syntax_highlighting_editor(self):
        ...
        self.assertIn("function guidedComboInput", mkexp2_web.HTML)
        self.assertIn("function guidedOptionValuesFromDatalist", mkexp2_web.HTML)
        self.assertIn("guided-combo-options", mkexp2_web.HTML)
        self.assertIn("guided-combo-option", mkexp2_web.HTML)
        self.assertNotIn("setAttribute('list'", mkexp2_web.HTML)
        ...
        self.assertIn("function guidedAlgorithmSelectionGroups", mkexp2_web.HTML)
        self.assertIn("function refreshGuidedAlgorithmSelections", mkexp2_web.HTML)
        self.assertIn("Custom algorithms", mkexp2_web.HTML)
        self.assertIn("Premade algorithms", mkexp2_web.HTML)
        self.assertIn("for (const name of algorithmMap.keys()) algorithmOptions.delete(name)", mkexp2_web.HTML)
        self.assertNotIn("guided-custom-algorithm-card", mkexp2_web.HTML)
        self.assertNotIn("guided-algorithm-badge", mkexp2_web.HTML)
        self.assertIn(".guided-check.custom", mkexp2_web.HTML)
        self.assertIn("experimentsTitle.textContent = 'Experiments'", mkexp2_web.HTML)
        self.assertNotIn("experimentsTitle.textContent = 'Experiment functions'", mkexp2_web.HTML)
        self.assertIn("guided-arg-token", mkexp2_web.HTML)
        self.assertIn("input.addEventListener('keydown'", mkexp2_web.HTML)
        self.assertIn("event.key !== ' ' && event.key !== 'Enter'", mkexp2_web.HTML)
        ...
        self.assertNotIn("/guided/render", mkexp2_web.HTML)
        ...
        self.assertIn('id="probe-body" class="panel-body hidden"', mkexp2_web.HTML)
        self.assertIn('id="probe-output"', mkexp2_web.HTML)
        self.assertIn('id="probe-toggle"', mkexp2_web.HTML)
        self.assertIn('id="probe-refresh"', mkexp2_web.HTML)
        self.assertLess(mkexp2_web.HTML.index('id="probe-toggle"'), mkexp2_web.HTML.index('id="probe-refresh"'))
        self.assertIn("Load Probe", mkexp2_web.HTML)
        self.assertIn("Hide Probe", mkexp2_web.HTML)
        self.assertIn("function toggleProbePanel", mkexp2_web.HTML)
        self.assertIn("function resetProbePanel", mkexp2_web.HTML)
        self.assertNotIn('id="probe-run"', mkexp2_web.HTML)
        ...
        self.assertIn('id="describe-refresh"', mkexp2_web.HTML)
        self.assertLess(mkexp2_web.HTML.index('id="describe-toggle"'), mkexp2_web.HTML.index('id="describe-refresh"'))
        self.assertIn("Load Reference", mkexp2_web.HTML)
        ...
        self.assertIn('id="dashboard-open"', mkexp2_web.HTML)
        self.assertIn('class="app dashboard-mode"', mkexp2_web.HTML)
        self.assertIn('class="sidebar-nav-button active"', mkexp2_web.HTML)
        self.assertIn("className = 'sidebar-section-title experiment-list-title'", mkexp2_web.HTML)
        self.assertLess(mkexp2_web.HTML.index('id="dashboard-open"'), mkexp2_web.HTML.index('id="archive-open"'))
        self.assertLess(mkexp2_web.HTML.index('id="archive-open"'), mkexp2_web.HTML.index("className = 'sidebar-section-title experiment-list-title'"))
        self.assertIn('aria-label="Experiment navigation"', mkexp2_web.HTML)
        self.assertIn("function renderSidebarNavState", mkexp2_web.HTML)
        self.assertIn("sidebarFocus: 'dashboard'", mkexp2_web.HTML)
        self.assertIn("state.archivePaneOpen = false;", mkexp2_web.HTML)
        self.assertIn("state.sidebarFocus === 'archive'", mkexp2_web.HTML)
        self.assertIn(".app.dashboard-mode .view-tabs", mkexp2_web.HTML)
        self.assertIn("classList.toggle('dashboard-mode'", mkexp2_web.HTML)
        self.assertNotIn('<button class="view-tab active" data-view="dashboard-view">Dashboard</button>', mkexp2_web.HTML)
        self.assertIn('<section id="dashboard-view" class="view-panel active">', mkexp2_web.HTML)
        self.assertIn('<section id="experiment-view" class="view-panel">', mkexp2_web.HTML)
        self.assertIn("activeView: 'dashboard-view'", mkexp2_web.HTML)
        self.assertIn("dashboardProgress", mkexp2_web.HTML)
        self.assertIn("dashboardProgressRequests", mkexp2_web.HTML)
        self.assertIn("nodeStatusPayload", mkexp2_web.HTML)
        self.assertIn("queuePayload", mkexp2_web.HTML)
        self.assertIn("function renderDashboard", mkexp2_web.HTML)
        self.assertIn("async function loadDashboardRunningProgress", mkexp2_web.HTML)
        self.assertIn("function renderDashboardRowProgress", mkexp2_web.HTML)
        ...
        self.assertIn("Submitted & Recent", mkexp2_web.HTML)
        self.assertNotIn("Running Now", mkexp2_web.HTML)
        self.assertIn("const runningRows = dashboardSortedExperiments(running || []);", mkexp2_web.HTML)
        self.assertNotIn("unpinnedRunning", mkexp2_web.HTML)
        self.assertNotIn("renderDashboardStat(summary, 'Pinned'", mkexp2_web.HTML)
        self.assertIn("renderDashboardCluster", mkexp2_web.HTML)
        self.assertIn("function renderDashboardQueue", mkexp2_web.HTML)
        self.assertIn('id="dashboard-queue"', mkexp2_web.HTML)
        self.assertIn('id="dashboard-queue-refresh" class="icon-button" aria-label="Reload Slurm queue"', mkexp2_web.HTML)
        self.assertNotIn('id="dashboard-queue-summary"', mkexp2_web.HTML)
        self.assertIn("loadQueue().catch(err => out(String(err)))", mkexp2_web.HTML)
        self.assertIn("selectMostRecent: false", mkexp2_web.HTML)
        self.assertIn("bootAuthenticatedUi({ selectMostRecent: false })", mkexp2_web.HTML)
        ...
        self.assertIn("function formatGermanDateTimeValue", mkexp2_web.HTML)
        self.assertIn("${padDatePart(date.getDate())}.${padDatePart(date.getMonth() + 1)}.${date.getFullYear()}", mkexp2_web.HTML)
        ...
        self.assertIn("Run Counts", mkexp2_web.HTML)
        self.assertIn("Success", mkexp2_web.HTML)
        self.assertIn("Timeouts", mkexp2_web.HTML)
        self.assertIn("Imbalanced", mkexp2_web.HTML)
        self.assertIn("Failed", mkexp2_web.HTML)
        self.assertIn("statsMatrixIncludeImbalanced", mkexp2_web.HTML)
        self.assertIn("function isMissingStatValue", mkexp2_web.HTML)
        self.assertIn("if (isMissingStatValue(value)) return 'n/a';", mkexp2_web.HTML)
        ...
        self.assertIn("function scrollSelectedLogIntoView", mkexp2_web.HTML)
        self.assertIn("list.scrollTo({ top: Math.max(0, list.scrollTop + centeredDelta), behavior: 'auto' });", mkexp2_web.HTML)
        self.assertIn("if (selectedLogInListing) scrollSelectedLogIntoView();", mkexp2_web.HTML)
        ...
        self.assertIn('aria-label="Create plot artifacts"', mkexp2_web.HTML)
        self.assertIn('>Create</span>', mkexp2_web.HTML)
        self.assertNotIn('id="plot-running"', mkexp2_web.HTML)
        self.assertIn("function setPlotCreateButtonContent", mkexp2_web.HTML)
        self.assertIn("Generating plot artifacts", mkexp2_web.HTML)
        self.assertIn('id="plot-generate-modal"', mkexp2_web.HTML)
        self.assertIn('id="plot-generate-modal-title" class="modal-title">Create Plot Artifacts</div>', mkexp2_web.HTML)
        self.assertNotIn("Choose plot types, data sources, and an artifact label.", mkexp2_web.HTML)
        self.assertIn('id="plot-generate-close"', mkexp2_web.HTML)
        self.assertNotIn('id="plot-generate-cancel"', mkexp2_web.HTML)
        self.assertLess(mkexp2_web.HTML.index('id="plot-sources"'), mkexp2_web.HTML.index('id="add-plot-source"'))
        ...
        self.assertNotIn("function deletePlotArtifact(", mkexp2_web.HTML)
        self.assertNotIn("plot-artifact-mini-button", mkexp2_web.HTML)
        self.assertNotIn("Delete this plot PDF", mkexp2_web.HTML)
        self.assertIn("meta.textContent = `${sources || 'no sources'}; ${formatBytes(artifact.size)}`;", mkexp2_web.HTML)
        self.assertNotIn("${artifact.label || artifact.plot_id}; ${sources}; ${formatBytes(artifact.size)}", mkexp2_web.HTML)
        ...
        self.assertNotIn('id="job-details-close-footer"', mkexp2_web.HTML)
        self.assertIn("stateText !== 'PENDING' && stateText !== 'PD'", mkexp2_web.HTML)
        self.assertIn("formatGermanDateTimeValue(data.generated_at)", mkexp2_web.HTML)
        ...
        self.assertIn('.app.share-mode [data-view="dashboard-view"]', mkexp2_web.HTML)
        self.assertIn(".app.share-mode #dashboard-open", mkexp2_web.HTML)
        self.assertIn(".app.share-mode #dashboard-view", mkexp2_web.HTML)
        ...
        self.assertIn('id="archive-open" class="archive-nav-button"', mkexp2_web.HTML)
        ...
        self.assertIn("function openArchivePane", mkexp2_web.HTML)
        self.assertNotIn('id="archive-modal"', mkexp2_web.HTML)
        ...
        self.assertIn("state.selectedArchived && state.selected === exp.id ? ' active' : ''", mkexp2_web.HTML)
        self.assertIn(".archive-item.active", mkexp2_web.HTML)
        self.assertIn("item.setAttribute('role', 'button')", mkexp2_web.HTML)
        self.assertIn("item.onclick = () => selectArchivedExperiment", mkexp2_web.HTML)
        self.assertIn("item.onkeydown = event =>", mkexp2_web.HTML)
        self.assertIn("text.className = 'archive-open-button'", mkexp2_web.HTML)
        self.assertIn(".experiment-row:hover", mkexp2_web.HTML)
        self.assertIn(".archive-item:focus-visible", mkexp2_web.HTML)
        self.assertIn("modal-header-actions", mkexp2_web.HTML)
        self.assertIn("event.stopPropagation()", mkexp2_web.HTML)
        self.assertNotIn("open.title = `Open archived experiment", mkexp2_web.HTML)
        ...
        self.assertIn("await selectExperiment(result.active_id, { keepArchivePane });", mkexp2_web.HTML)
        self.assertIn("{ keepArchivePane: true }", mkexp2_web.HTML)
        self.assertIn('Danger Zone', mkexp2_web.HTML)
        self.assertIn("padding-top: 14px;", mkexp2_web.HTML)
        ...
        self.assertIn(".icon-button.is-spinning svg", mkexp2_web.HTML)
        self.assertIn('id="refresh-progress"', mkexp2_web.HTML)
        self.assertNotIn('id="progress-loading-indicator"', mkexp2_web.HTML)
        ...
        self.assertIn("function setProgressLoading", mkexp2_web.HTML)
        self.assertIn("function renderProgressLoading", mkexp2_web.HTML)
        self.assertIn("setIconButtonSpinning('refresh-progress')", mkexp2_web.HTML)
        self.assertNotIn("progress-title-spinner", mkexp2_web.HTML)
        self.assertNotIn("Auto reload in", mkexp2_web.HTML)
        self.assertNotIn("Auto reloading progress...", mkexp2_web.HTML)
        ...
        self.assertIn("}, AUTO_RELOAD_INTERVAL_MS)", mkexp2_web.HTML)
        ...
        self.assertIn('class="settings-layout"', mkexp2_web.HTML)
        self.assertIn('class="settings-content"', mkexp2_web.HTML)
        self.assertIn('data-settings-section="settings-editor"', mkexp2_web.HTML)
        self.assertIn('data-settings-section="settings-results"', mkexp2_web.HTML)
        self.assertIn("function initializeSettingsNav", mkexp2_web.HTML)
        self.assertIn("function updateSettingsNavFromScroll", mkexp2_web.HTML)
        self.assertIn("scrollSettingsSection(initialSettingsSection(), 'auto')", mkexp2_web.HTML)
        self.assertNotIn('href="#settings-editor"', mkexp2_web.HTML)
        ...
        self.assertIn("prefers-color-scheme: dark", mkexp2_web.HTML)
        self.assertIn("function effectiveTheme", mkexp2_web.HTML)
        ...
        self.assertIn("function setIconButtonSpinning", mkexp2_web.HTML)
        self.assertIn("function startNodeStatusPolling", mkexp2_web.HTML)
        self.assertIn("setIconButtonSpinning('refresh-status')", mkexp2_web.HTML)
        self.assertIn("const AUTO_RELOAD_INTERVAL_MS = 15000", mkexp2_web.HTML)
        ...
        self.assertNotIn('id="queue-summary"', mkexp2_web.HTML)
        ...
        self.assertNotIn('class="dashboard-actions"', mkexp2_web.HTML)
        self.assertNotIn('id="dashboard-create"', mkexp2_web.HTML)
        self.assertNotIn('id="dashboard-refresh"', mkexp2_web.HTML)
        self.assertNotIn('id="dashboard-archive"', mkexp2_web.HTML)
        self.assertNotIn('id="dashboard-git"', mkexp2_web.HTML)
        ...
        self.assertIn("async function saveBeforeEditorModeSwitch", mkexp2_web.HTML)
        self.assertIn("Save text changes before switching to Guided?", mkexp2_web.HTML)
        self.assertIn("Save guided changes before switching to Text?", mkexp2_web.HTML)
        self.assertNotIn("renderGuidedExperimentPreview", mkexp2_web.HTML)
