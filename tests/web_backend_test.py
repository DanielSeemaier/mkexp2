...
class WebBackendTest(unittest.TestCase):
    ...
    def test_html_contains_syntax_highlighting_editor(self):
        ...
        self.assertIn(".git-status-column.added", mkexp2_web.HTML)
        self.assertIn(".git-status-column.modified", mkexp2_web.HTML)
        self.assertIn(".git-status-column.deleted", mkexp2_web.HTML)
