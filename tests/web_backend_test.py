...
class WebBackendTest(unittest.TestCase):
    ...
    def test_html_contains_syntax_highlighting_editor(self):
        ...
        self.assertIn('class="sidebar-tree-header"', mkexp2_web.HTML)
        self.assertLess(mkexp2_web.HTML.index('id="dashboard-open"'), mkexp2_web.HTML.index('id="archive-open"'))
        self.assertLess(mkexp2_web.HTML.index('id="archive-open"'), mkexp2_web.HTML.index('class="sidebar-tree-header"'))
