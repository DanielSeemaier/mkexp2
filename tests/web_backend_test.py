...
class WebBackendTest(unittest.TestCase):
    ...
    def test_html_contains_syntax_highlighting_editor(self):
        ...
        self.assertIn('id="progress-auto-status"', mkexp2_web.HTML)
        ...
        self.assertIn("function renderProgressAutoStatus", mkexp2_web.HTML)
        self.assertIn("Auto reloading progress...", mkexp2_web.HTML)
        self.assertIn("Auto reload in", mkexp2_web.HTML)
        self.assertIn("Auto reload failed; retry in", mkexp2_web.HTML)
